...
#define vinstr_waitline(line) (VPUINST_WAITLINE | ((line & 0x00FFFFU) << 8))
#define vinstr_waitcolumn(column) (VPUINST_WAITCOLUMN | ((column & 0x00FFFFU) << 8))
#define vinstr_setpixoff(offset) (VPUINST_SETPIXOFF | ((offset & 0xFFU) << 8))
#define vinstr_setcacheroff(offset) (VPUINST_SETCACHEROFF | ((offset & 0xFFU) << 8))
#define vinstr_setcachewoff(offset) (VPUINST_SETCACHEWOFF | ((offset & 0xFFU) << 8))
#define vinstr_setpal(index, reg) (VPUINST_SETPAL | ((index & 0x00FFU) << 8) | ((reg & 0x00FFU) << 16))
#define vinstr_setacc(value) (VPUINST_SETACC | ((value & 0x00FFFFFFU) << 8))
#define vinstr_copyreg(dest, src) (VPUINST_COPYREG | ((dest & 0x00FFU) << 8) | ((src & 0x00FFU) << 16))
#define vinstr_jump(address) (VPUINST_JUMP | ((address & 0x00FFFFFFU) << 8))
#define vinstr_add(reg1, reg2) (VPUINST_ADD | ((reg1 & 0x00FFU) << 8) | ((reg2 & 0x00FFU) << 16))
#define vinstr_compare(reg1, reg2) (VPUINST_COMPARE | ((reg1 & 0x00FFU) << 8) | ((reg2 & 0x00FFU) << 16))
#define vinstr_branch(condition, address) (VPUINST_BRANCH | ((condition & 0xFFU) << 8) | ((address & 0xFFFFU) << 16))
#define vinstr_mul(reg, value) (VPUINST_MUL | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_div(reg, value) (VPUINST_DIV | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_mod(reg, value) (VPUINST_MOD | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_and(reg, value) (VPUINST_AND | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_or(reg, value) (VPUINST_OR | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_xor(reg, value) (VPUINST_XOR | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_not(reg) (VPUINST_NOT | ((reg & 0x00FFU) << 8))
#define vinstr_shl(reg, value) (VPUINST_SHL | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_shr(reg, value) (VPUINST_SHR | ((reg & 0x00FFU) << 8) | ((value & 0xFFFFU) << 16))
#define vinstr_load(reg, address) (VPUINST_LOAD | ((reg & 0x00FFU) << 8) | ((address & 0xFFFFU) << 16))
#define vinstr_store(reg, address) (VPUINST_STORE | ((reg & 0x00FFU) << 8) | ((address & 0xFFFFU) << 16))
